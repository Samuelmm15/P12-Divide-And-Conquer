...
int main(int argc, char const *argv[]) {
    if (argc == 2) {
        ...
        if (option == "-h" || option == "--help") {
            ...
            std::cout << "Ayuda: ./mainDivideAndConquer [Nº Entero Grande Nº Entero Grande | -k [Nº Entero Grande Nº Entero Grande] | -m [Nº Entero Grande Nº Entero Grande]]" << std::endl;
